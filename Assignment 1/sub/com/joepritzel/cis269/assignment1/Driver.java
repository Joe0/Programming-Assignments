...
import com.joepritzel.cis269.assignment1.search.LinearSearchStrategy;
...
public class Driver {
	...
	public static void main(String[] args) throws IOException {
		...
		AccountAggregate data = new AccountAggregate(
				new FileBasedRepo(dataFile), new LinearSearchStrategy());
